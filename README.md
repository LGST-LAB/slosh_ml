# SLOSH-ML User Guide
The documentation for SLOSH-ML can be accessed at [https://lgst-lab.github.io/slosh_ml/](https://lgst-lab.github.io/slosh_ml/).
...
## Using Contour Designer
1. Run the app through the Design Contour button in SLOSH-ML.
2. Enter the starting points for the outer contour and select continue
3. Select the segment type from the drop-down menu at the top of the right side of the screen and input the required z and r coordinates for the selected segment type to create the outer contour. The segment must have increasing z coordinates everywhere and must produce a valid line, circle, or ellipse; otherwise, a warning will appear. Input any comments for the segment in the comments box. When the segment is correctly inputted, select either the Add Line Segment button to continue adding another line segment or the Finish Outer Contour button to complete the outer contour.
4. Select the segment type from the drop-down menu at the top of the right side of the screen and input the required z and r coordinates for the selected segment type to create the inner contour. The segment must have increasing z coordinates everywhere and must produce a valid line, circle, or ellipse; otherwise, a warning will appear. Input any comments for the segment in the comments box. When the segment is correctly inputted, select either the Add Line Segment button to continue adding another line segment or the Finish Inner Contour button to complete the inner contour. When the Finish Inner Contour Button is pressed, the contour will be completed by connecting the start points of the inner and outer contours with a horizontal line and connecting the end points of the inner and outer contours with a horizontal line.
5. When finished, select the Save button to save the contour or the Save and Load button to save the contour and immediately load it into SLOSH-ML.
...
8. I. E. Sumner, "Preliminary Experimental Investigation of Frequencies and Forces Resulting From Liquid Sloshing in Toroidal Tanks," Tech. Rep. TN-D-1709, NASA, June 1963.
9. Shane B. Coogan and Steven Green, "Critical Review of Damping Prediction Methods for Annular Ring Slosh Baffles," AIAA 2019-4436, AIAA Propulsion and Energy 2019 Forum, August 2019.
